...
# -*- coding: utf-8 -*-
#
# File: /opt/scripts/dnssync/zones.py
...
# Optional: Additional utility functions or logging configuration

def configure_zones_logging(log_level=logging.INFO):
    """
    Configure logging for zones module.
